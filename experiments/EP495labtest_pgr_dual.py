...
class EP495labtest_pgr_dual(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        super(EP495labtest_pgr_dual, self).__init__(cpid, txctrfreq=txctrfreq, rxctrfreq=rxctrfreq,
