...
class EP495labtest_rkn_tri(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        slice_2['txfreq'] = 11750

        slice_3 = copy.deepcopy(slice_1)
        slice_3['txfreq'] = 13150

        list_of_slices = [slice_1, slice_2, slice_3]
        sum_of_freq = 0
        ...
        super(EP495labtest_rkn_tri, self).__init__(cpid, txctrfreq=txctrfreq, rxctrfreq=rxctrfreq,
                comment_string='Twofsound simultaneous in-sequence')

        self.add_slice(slice_1)

        self.add_slice(slice_2, interfacing_dict={0: 'PULSE'})
        self.add_slice(slice_3, interfacing_dict={0: 'PULSE'})
