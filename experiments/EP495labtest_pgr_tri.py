...
class EP495labtest_pgr_tri(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        super(EP495labtest_pgr_tri, self).__init__(cpid, txctrfreq=txctrfreq, rxctrfreq=rxctrfreq,
