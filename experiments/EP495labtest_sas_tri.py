...
class EP495labtest_sas_tri(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        super(EP495labtest_sas_tri, self).__init__(cpid, txctrfreq=txctrfreq, rxctrfreq=rxctrfreq,
