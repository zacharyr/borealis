...
class EP495labtest_cly_dual(ExperimentPrototype):
    ...
    def __init__(self):
        ...
        super(EP495labtest_cly_dual, self).__init__(cpid, txctrfreq=txctrfreq, rxctrfreq=rxctrfreq,
